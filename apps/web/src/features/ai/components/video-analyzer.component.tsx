...
import type { YouTubeVideo, YouTubeComment, ViralAnalysisResult, ChatMessage } from "@repo/types";
      ...
      <div className="bg-gradient-to-br from-purple-50 via-white to-indigo-50 rounded-xl border border-purple-100 p-10 shadow-sm text-center">
        ...
        {error && (
          <div className="mt-6 flex justify-center">
            <p className="text-red-600 text-sm bg-red-50 border border-red-100 px-4 py-2 rounded-lg">
              {error}
            </p>
          </div>
        )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-700 leading-relaxed text-sm border-l-2 border-blue-500 pl-4">
              {analysis.summary}
            </p>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {analysis.hooks.map((hook, i) => (
                    <li
                      key={i}
                      className="flex gap-2 text-sm text-gray-700 bg-amber-50/50 p-2.5 rounded-lg border border-amber-100/50"
                    >
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {analysis.viralReasons.map((reason, i) => (
                    <li
                      key={i}
                      className="flex gap-2 text-sm text-gray-700 bg-purple-50/50 p-2.5 rounded-lg border border-purple-100/50"
                    >
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl border border-emerald-100 p-6 shadow-sm">
            ...
            <ul className="space-y-3">
              {analysis.contentIdeas.map((idea, i) => (
                <li
                  key={i}
                  className="flex gap-3 text-sm text-gray-800 bg-white/80 p-3.5 rounded-lg border border-emerald-100/50 shadow-sm"
                >
