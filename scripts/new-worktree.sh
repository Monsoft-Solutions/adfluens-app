...
sed -i '' "s|^VITE_PORT=.*|VITE_PORT=$WEB_PORT|" .env
sed -i '' "s|^VITE_API_URL=.*|VITE_API_URL=http://localhost:$API_PORT|" .env
sed -i '' "s|^BETTER_AUTH_URL=.*|BETTER_AUTH_URL=http://localhost:$API_PORT|" .env
sed -i '' "s|^APP_URL=.*|APP_URL=http://localhost:$WEB_PORT|" .env
...
echo ""
echo "💡 Open this worktree in a new Claude Code window to work on it"
echo "   File → Open Folder → $WORKTREE_DIR"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
